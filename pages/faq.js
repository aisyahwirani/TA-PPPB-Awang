...
export default function faq() {
  return (
    <div>
      <Meta title="Reep Kostan: FAQ" />

      <Header />

      <section className="text-gray-600 body-font bg-green-50 py-20">
        <div className="container px-5 py-52 mx-auto">
          <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
            ...
            Aplikasi resep makanan agar memudahkan saya sebagai anak kost yang tidak bisa memasak
            ...
            <p className="text-gray-800">Diponegoro University</p>
          </div>
        </div>
      </section>
